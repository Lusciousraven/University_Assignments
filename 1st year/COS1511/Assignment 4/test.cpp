...
const double flightTimes[5][2] = {{7.00 ,9.30},{9.00 ,11.30},{11.00,13.30},{13.00,15.30},{15.00,17.30}};
...
void displayTicket (booking b)
{
    ...
    cout << "Thank you for booking with COS1511. Your travel agent for queries is Annie Matthew" << endl;
    cout << " " << "*" << endl;
