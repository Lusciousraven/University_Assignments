...
namespace {
struct qt_meta_stringdata_PrimeFinder_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_PrimeFinder_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_PrimeFinder_t qt_meta_stringdata_PrimeFinder = {
    {
        QT_MOC_LITERAL(0, 11),  // "PrimeFinder"
        QT_MOC_LITERAL(12, 11),  // "primesFound"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 10),  // "QList<int>"
        QT_MOC_LITERAL(36, 6)   // "primes"
    },
    "PrimeFinder",
    "primesFound",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_PrimeFinder[] = {
...
Q_CONSTINIT const QMetaObject PrimeFinder::staticMetaObject = { {
    ...
    qt_meta_stringdata_PrimeFinder.offsetsAndSizes,
    qt_meta_data_PrimeFinder,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_PrimeFinder_t,
        // Q_OBJECT / Q_GADGET
...
void *PrimeFinder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PrimeFinder.stringdata0))
